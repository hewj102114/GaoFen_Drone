...
void cb_front_rgb(const sensor_msgs::ImageConstPtr &ptr_msg)
{
    ...
    {
        sprintf(filename, "/home/pengrui/Documents/GaoFen_Drone/resource/img_test/r1-%d.png", ptr_msg->header.seq);
...
int main(int argc, char **argv)
{
    ...
    while (ros::ok())
    {
        ...
        {
            char filename[200];
            sprintf(filename, "/home/pengrui/Documents/GaoFen_Drone/resource/img_test/r1%d.png", FN++);
            cv::imwrite(filename, img_rgb);
        }
        rate.sleep();
        ros::spinOnce();
